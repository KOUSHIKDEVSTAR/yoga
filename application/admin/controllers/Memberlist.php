...

{
    ...
    */
    ...
    public function add(){
        ...
        $cancelation_policy = $this->model_branch->getCancelationPolicyData();
    ...
    public function store(){
        ...
        $data =[
            ...
            'cancel_policy'=>$this->input->post('cancelation_policy'),

            'is_show'=>$this->input->post('show_product'),

            'is_sharable'=>$this->input->post('is_sharable'),
