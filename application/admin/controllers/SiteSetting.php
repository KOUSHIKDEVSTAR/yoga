...

{
	...
	public function coupon_list(){
		...
		$this->data['site_data'] = $site_data;
		$coupon_data = $this->model_sitesettings->getCouponData();

		$this->data['coupon_data'] = $coupon_data;

		$this->render_template('coupon/index', $this->data);	
	...
	public function coupon_add(){
		...
		$this->data['site_data'] = $site_data;
		$this->render_template('coupon/add', $this->data);

	}
	public function coupon_submit(){
		$data = [
			'coup_title'=>$this->input->post('title'),
			'coup_for'=>$this->input->post('used_for'),
			'coup_amnt'=>$this->input->post('copn_amt'),
			'coup_type'=>$this->input->post('type'),
			'coup_start_time'=>$this->input->post('start_date'),
			'coup_end_time'=>$this->input->post('end_date'),
			'coup_code'=>$this->input->post('copn_code'),
			'applicable_amnt'=>$this->input->post('applicable_amnt'),

		];
		$this->db->insert('tbl_coupons',$data);
		return redirect('siteSetting/coupon_list');
	}
	...
	public function coupon_edit($id){
		...
		$this->db->where('coup_id',$id);
		
		$this->data['coupon_edit'] = $this->db->get()->result();

		$this->render_template('coupon/edit', $this->data);	
