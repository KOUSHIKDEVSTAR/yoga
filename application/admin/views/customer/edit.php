                             ...
                             <div class="row">
                                 <div class="col-12">
                                     <div class="card">
                                         ...
                                         <div class="card-body">
                                             <form class="form" method="POST" action="<?= base_url('customers/update');?>"
                                                    ...
                                                    <input type="hidden" name="id" value="<?= $customer_details[0]->cust_id;?>"> 
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             ...
                                                             <input type="text" id="" class="form-control"
                                                                 placeholder="Full Name" name="name" value="<?= $customer_details[0]->full_name;?>"  required="" />
                                                         </div>
                                                     </div>
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             ...
                                                             <input type="email" id="" class="form-control"
                                                                 placeholder="Email" name="email" value="<?= $customer_details[0]->email;?>"required=""  />
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             ...
                                                             <input type="text" id="" class="form-control"
                                                                 ...
                                                                 name="mobile_number" value="<?= $customer_details[0]->mobile_number;?>"  required="" />
                                                         </div>
                                                     </div>
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             ...
                                                             <img src="<?= base_url('uploads/customer_details/');?><?= $customer_details[0]->pr_image;?>" style="width: 40px;height: 40px;">
