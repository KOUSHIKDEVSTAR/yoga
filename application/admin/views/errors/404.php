...
<head>
    ...
    <title>Error - FitPlus  - Bootstrap HTML admin template</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
...
<div class="app-content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <!-- Error page-->
                <div class="misc-wrapper"><a class="brand-logo" href="<?php echo base_url(); ?>">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <a class="btn btn-primary mb-2 btn-sm-block" href="<?php echo base_url(); ?>">Back to home</a>
                            <img class="img-fluid" src="<?php echo base_url(); ?>app-assets/images/pages/error.svg" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
