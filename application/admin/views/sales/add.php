                        ...
                        <div class="col-xl-9 col-md-8 col-12">
                            <div class="card invoice-preview-card">
                                    ...
                                    <div class="row row-bill-to invoice-spacing">
                                        <div class="col-xl-8 mb-lg-1 col-bill-to ps-0">
                                            ...
                                            <div class="invoice-customer">
                                                <select class="invoiceto form-select" id="cust_data">
                                ...
                                <div class="card-body invoice-padding invoice-product-details">
                                    <form class="source-item" action="<?= base_url('sales/store');?>" enctype="multipart/form-data" method="POST">
                                                    ...
                                                    <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                        <div class="row w-100 pe-lg-0 pe-1 py-2">
                                                            ...
                                                            <div class="col-lg-6 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                <p class="card-text col-title mb-md-50 mb-0">Product</p>
                                                                <select class="form-select item-details" name="product_id" id="product_id" required="">
                                                            ...
                                                            <div class="col-lg-6 col-3 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                                <p class="card-text col-title mb-md-50 mb-0">Subscription Type</p>
                                                                <select class="form-select item-details" id="subscription_id" name="subscription" required="">
                                                                    <option value="">Choose One</option>
                                                             ...
                                                             <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                ...
                                                                <input type="text" name="cost" id="cost" class="form-control" value="" required="" readonly="">
                                                                
                                                               
                                                            </div>
                                                            <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Quantity</p>
                                                            ...
                                                            <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                ...
                                                                <input type="text" name="tax" id="tax" class="form-control" value="" required="" readonly="">
                                                                
                                                               
                                                            </div>
                                                            <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Discount</p>
                                                                <input type="number" name="discount" id="discount" class="form-control" value="" required="">
                                                                
                                                               
                                                            </div>
                                                             <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Total Price</p>
                                                                <input type="text" name="total_price" class="form-control" id="total_price" value="" required="" readonly="">
                                                                
                                                               
                                                            </div>
                                                             <div class="col-lg-4 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Received Type</p>
                                                               <select class="form-select item-details" name="recved_type" required=""> 
                                                                    <option value="">Choose One</option>
                                                            ...
                                                            <div class="col-lg-6 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Received Amount</p>
                                                               <input type="text" name="recved_amnt" value="" class="form-control" id="recved_amnt" required="">
                                                               
                                                            </div>
                                                            <div class="col-lg-6 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Due Amount</p>
                                                               <input type="text" name="due_amt" value="" class="form-control" required="" id="due_amt" readonly="">
                                                               
                                                            </div>
                                                              <div class="col-lg-6 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Transcation Id</p>
                                                               <input type="text" name="tranac_id" value="" class="form-control">
                                                               
                                                            </div>
                                                            <div class="col-lg-6 col-3 mb-lg-0 mb-2 mt-lg-0 ">
                                                                <p class="card-text col-title mb-md-50 mb-0 mt-2">Transcation Attachments</p>
                                                               <input type="file" name="transc_attachments" value="" class="form-control">
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-12 px-0">
                                                <button type="submit" class="btn btn-primary btn-sm btn-add-new" data-repeater-create>Add Sale
    ...
    <script type="text/javascript">
        $(document).ready(function(e){
            $('#product_id').on('change',function(e){
                ...
                var base_url = '<?= base_url();?>';
            $.ajax({
                url: base_url + 'sales/product_by_id',
                data: {
                    id: product_id,
                },
                dataType: "json",
                ...
                async: true,
                success: function(data) {
                    data = data.data.products_details[0];
                    console.log("Data",data);
                    $('#cost').val(data.discounted_price);
                }
                });
