...
<head>
    ...
    <title><?php echo $page_title; ?> - FitPlus </title>
                    ...
                    <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                        <div>
                            <div class="d-flex mb-1">
                                ...
                                <h3 class="text-primary fw-bold ms-1">FitPlus </h3>
                            </div>
                        ...
                        <div class="mt-md-0 mt-2">
                            <h4 class="fw-bold text-end mb-1">INVOICE #<?=$sales_details[0]->invoice_no;?></h4>
                            <div class="invoice-date-wrapper mb-50">
                                <span class="invoice-date-title">Date Issued:</span>
                                <span class="fw-bold"> <?=$sales_details[0]->created_at;?></span>
                            </div>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong><?=$sales_details[0]->due_amt;?></strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script src="<?php echo base_url(); ?>app-assets/vendors/js/vendors.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>app-assets/js/scripts/pages/app-invoice-print.js"></script>
    <!-- END: Page JS-->
