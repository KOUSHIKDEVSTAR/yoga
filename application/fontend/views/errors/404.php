...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin/app-assets/css/pages/page-misc.css">
    <!-- END: Page CSS-->
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="<?php echo base_url(); ?>">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <img class="img-fluid" src="<?php echo base_url(); ?>admin/app-assets/images/pages/error.svg" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
