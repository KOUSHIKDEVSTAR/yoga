...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>admin/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
...
<footer class="custome-footer">
    ...
    <script src="<?php echo base_url(); ?>admin/app-assets/vendors/js/extensions/sweetalert2.all.min.js"></script>
    <script src="<?php echo base_url(); ?>admin/app-assets/vendors/js/extensions/polyfill.min.js"></script>

    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url(); ?>admin/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
