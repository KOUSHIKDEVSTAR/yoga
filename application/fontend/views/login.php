...
<head>
    ...
    <title>Studiomanager Yoga - Health and mind </title>
                ...
                <div class="header-logo">
                    ...
                    <div class="header-logo-wraper">
                        ...
                        <a class="brand-logo" href="<?php echo base_url();?>">
                            ...
                            <img src="<?php echo base_url();?>admin/app-assets/images/logo/logo.png" style="height: 30px;"> 
            ...
            <div class="col-lg-6">
                ...
                <div class="header-btms">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo base_url('profile/booking');?>"><span class="text" >Schedule</span><span class="icon"><i data-feather="calendar"></i></span></a></li>
                        <li><a href="<?php echo base_url('memberlist');?>"><span class="text" >Subscription </span><span class="icon" ><i data-feather="command"></i></span></a></li>

                        <li><a href="<?php echo base_url('Productlist');?>"><span class="text" >My Store</span><span class="icon" > <i data-feather="columns"></i></span></a></li>

                        <li><a href="<?php echo base_url('profile');?>"><span class="text" >Profile </span><span class="icon" ><i data-feather="user"></i></span></a></li>

                        <!-- <li><a href="<?php echo base_url('login/logout');?>"><span class="text" >Logout </span><span class="icon" ><i data-feather='log-out'></i></span></a></li> -->
                        ...
                        <li><a href="<?php echo base_url();?>"><span class="text" >Schedule</span><span class="icon"><i data-feather="calendar"></i></span></a></li>
                        <li><a href="<?php echo base_url('memberlist');?>"><span class="text" >Subscription </span><span class="icon" ><i data-feather="command"></i></span></a></li>
                        <li><a href="<?php echo base_url('Productlist');?>"><span class="text" >My Store</span><span class="icon" > <i data-feather="columns"></i></span></a></li>

                        <li><a href="<?php echo base_url('login');?>"><span class="text" >Login</span><span class="icon" > <i data-feather="user"></i></span></a></li>
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        swal({
                            ...
                            text: "Please check your given email!",
                            icon: "success",
                            button: "Done",
                        });;
                        </script>
                        ...
                        <?php } elseif($this->session->flashdata('error_act')){?>
                        <script type="text/javascript">
                        swal({
                            title: "Your Account is Suspended",
                            text: "Please Contact to Adminstration",
                            icon: "warning",
                            button: "Okey",
                        });
                        </script>

                        <?php } elseif($this->session->flashdata('error_paas')){?>
                        <script type="text/javascript">
                        swal({
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to Studio Manager! 👋</h2>
                                ...
                                <form class="auth-login-form mt-2" action="<?php echo base_url('login/auth') ?>" method="post">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" name="email" id="email" type="text"  placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">Password</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                             
                                            <input class="form-control form-control-merge" type="password"  name="password" id="password"  placeholder="············" aria-describedby="login-password" tabindex="2" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-1">
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a href="<?= base_url('register');?>"><span>&nbsp;Create an account</span></a></p>
