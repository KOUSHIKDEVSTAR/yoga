            ...
            <div class="content-body">
                <section class="app-user-view-account">
                    <div class="container">
                        <div class="row">
                        <!-- User Sidebar -->
                        <div class="col-xl-5 col-lg-5 col-md-7 order-1 order-md-0 offset-1">
                                ...
                                <div class="card-body">
                                    <div class="user-avatar-section">
                                        <div class="d-flex align-items-center flex-column">
                                            <img class="img-fluid rounded mt-3 mb-2" src="<?= base_url('admin/uploads/customer_details/');?><?= $customer_details[0]->pr_image;?>" height="110" width="110" alt="User avatar" />
                                    ...
                                    <div class="info-container">
                                        ...
                                        <div class="d-flex justify-content-center pt-2">
                                            <a href="<?=base_url('profile/edit');?>" class="btn btn-primary me-1">
                                                Edit
                                            </a>
                                        </div>
                                    </div>
