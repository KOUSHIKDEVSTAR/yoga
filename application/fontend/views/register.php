...
<head>
    ...
    <title>Register Page - Yoga</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-5 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="<?= base_url('register/store');?>" method="POST" enctype="multipart/form-data">
                                    <div class="mb-1">
                                        <label class="form-label" for="register-username">Fullname</label>
                                        <input class="form-control" id="register-username" type="text" name="full_name" placeholder="johndoe" aria-describedby="register-username" autofocus="" tabindex="1" />
                                    ...
                                    <div class="mb-1">
                                     ...
                                     <div class="mb-1">
                                        ...
                                        <input class="form-control" id="register-email" type="text" name="mobile" placeholder="1111111111" aria-describedby="register-email" minlength="10" maxlength="10" tabindex="2" />
                                        <span class="text-danger"><?php echo form_error('mobile'); ?></span>
                                    </div>
                                    <button class="btn btn-primary w-100" type="submit" tabindex="5">Sign up</button>
                                </form>
                                <p class="text-center mt-2"><span>Already have an account?</span><a href="<?= base_url('login');?>"><span>&nbsp;Sign in instead</span></a></p>
