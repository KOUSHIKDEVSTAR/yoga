                     ...
                     <div class="card-body border-bottom">
                         ...
                         <div class="row">
                             <div class="col-md-12">
                                 ...
                                 <a href="<?php echo base_url('siteSetting/tax_store');?>"><button type="button" class="btn btn-primary"
                             ...
                             <div class="row">
                                 <div class="col-12">
                                     <div class="card">
                                         ...
                                         <div class="card-body">
                                             <form class="form" method="POST" action="<?= base_url('siteSetting/tax_store');?>"
                                                 enctype="multipart/form-data">
                                                 <div class="row">
                                                     
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             <label class="form-label" for="city-column">Template Name
                                                                 </label>
                                                             <input type="text" id="" class="form-control"
                                                                 placeholder="Template Name" name="template_name" />
                                                         </div>
                                                     </div>
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             <label class="form-label" for="city-column">Tax Name
                                                                 </label>
                                                             <input type="text" id="" class="form-control"
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             <label class="form-label" for="city-column">Percentage(%)
                                                                 </label>
                                                             <input type="text" id="" class="form-control"
                                                     ...
                                                     <div class="col-md-6 col-12">
                                                         <div class="mb-1">
                                                             <label class="form-label"
                                                                 for="first-name-column">Applicable On</label>
                                                             <select class="form-select form-select-lg" name="applicable_on"
                                                                 id="selectLarge">
                                                                 <option>Choose One</option>
                                                                  <?php foreach($product_type as $product){?>
                                                                    <option value="<?=$product->fan_exp_id;?>"><?= $product->name;?></option>
