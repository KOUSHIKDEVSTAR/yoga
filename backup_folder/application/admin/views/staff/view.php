                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" id="first_name" name="first_name" class="form-control"
                                                 value="<?=$user_data[0]->firstname;?> " placeholder="First Name" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" id="last_name" value="<?=$user_data[0]->lastname;?>"
                                                 name="last_name" class="form-control" placeholder="Last Name" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="email" id="email-id-column" class="form-control"
                                                 value="<?=$user_data[0]->email;?>" name="email" placeholder="Email" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                     ...
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" id="email-id-column" class="form-control"
                                                 ...
                                                 placeholder="ID Docs Name" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" id="email-id-column" class="form-control"
                                                 ...
                                                 placeholder="ID Docs Number"readonly />
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" id="email-id-column" value="<?=$user_data[0]->tax_id;?>"
                                                 class="form-control" name="tax_id" placeholder="Tax Id" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="date" id="email-id-column" class="form-control" name="dob"
                                                 value="<?=$user_data[0]->dob;?>" placeholder="ID Docs Number" readonly/>
                                         </div>
                                     </div>
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             <label class="form-lael" for="email-id-column">Gender</label>
                                             <select class="form-select form-select-lg" id="selectLarge" name="gender" readonly>
                                                 <option selected>Choose One</option>
                                                 <option value="1"
                                     ...
                                     <div class="col-md-6 col-12">
                                         <div class="mb-1">
                                             ...
                                             <input type="text" value="<?= $user_data[0]->date_of_joining;?>"
